...
const user = new User('01', 'ariane@email.com', 'Ariane', 'senhadaariane', 'Olá, bom dia!');
...
const customer = new Customer('01', 'ariane@email.com', 'Ariane', 'senhadaariane', 'CreditCard', 'Olá, bom dia!');
...
export abstract class Place {
  ...
  const place = new Place('12246023');
